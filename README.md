...
R code for Cleaning and Working with Data to create Tidy data
...
Part 5 -- From the data set in above step, creates a second, independent tidy data set with the average of each variable for each activity and each subject
